                ...
                <div class="body-box">
                    ...
                    <div class="line">
                        ...
                        <div class="select" data-role="selectBox">
                            ...
                            <!-- 옵션 영역 -->
                            <ul class="hide">
                                <label for="leader"><li class="option-wrap">1</li></label>
                                <label for="leader"><li class="option-wrap">2</li></label>
                            </ul>
                        </div>
                        <div style="width: 30px;"></div>
                        ...
                        <div class="select" data-role="selectBox">
                            ...
                            <ul class="hide">
                                <label for="member"><li class="option-wrap">1</li></label>
                                <label for="member"><li class="option-wrap">2</li></label>
                                <label for="member"><li class="option-wrap">3</li></label>
                                <label for="member"><li class="option-wrap">4</li></label>
                            </ul>
                        </div>
                    </div>

                    ...
                    <div class="head-box">
                        <div class="name-box">
                            <div class="box1">
                                ...
                                <input type="text" name="prj_name" name="title">
                            </div>
                            <div class="box2">
                        ...
                        <div class="body-box">
                            <div class="line">
                                ...
                                <div class="prj" name="writer">${loginMember.name}</div>
                            </div>
                            <div class="line">
                                <div class="prj">팀</div>
                                <div class="select" data-role="selectBox">
                                    <span date-value="optValue" class="selected-option" id="teamvalue" name="team"><!-- 선택된 옵션 값이 출력되는 부분 --></span>
                                    <ul class="hide">
                                ...
                                <div class="select" data-role="selectBox">
                                    <span date-value="optValue" class="selected-option" id="leadervalue" name="leader"><!-- 선택된 옵션 값이 출력되는 부분 --></span>
                                    <!-- 옵션 영역 -->
                                    <ul class="hide">
                                ...
                                <div class="select" data-role="selectBox">
                                    <span date-value="optValue" class="selected-option" id="membervalue" name="member"><!-- 선택된 옵션 값이 출력되는 부분 --></span>
                                    <ul class="hide">
